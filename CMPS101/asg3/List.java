/**
   Name: Sean McGrath
   User ID: ssmcgrat
   Assignment: CMPS101 Programming Assignment 3 
*/
...
class List{
   ...
   private class Node{
      ...
      public String toString(){
       ...
       //equals: overides the object's equals method
   ...
   */
   int getIndex(){
      //if(this.cursor==null) return -1;
      return this.index;
   }



   // Object front():   returns front element in this list. Pre: length()>0
   Object front(){
      if(this.length()==0){
   ...
   // Object back(): Returns back element in this List. Pre: length()>0
   Object back(){
      if(this.length()==0){
   ...
   */
   ...
   // void prepend(Object data):  Inserts new element before front element in this List.
   ...
   // void append(Object data):   Inserts new element after back element in this List.
   ...
   */
   ...
   /**
      void insertAfter(Object data):    Inserts new element after cursor element in this List.
                                     Pre: length()>0, getIndex()>=0
   */
