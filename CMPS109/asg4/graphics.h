...
class object {
   ...
   public:
      ...
      object(shared_ptr<shape> ptr, vertex vert, rgbcolor col): 
                  pshape(ptr), center(vert), color(col) {} 
...
class window {
   ...
   private:
      ...
      static void move_selected_object(int deltax, int deltay);
   ...
   public:
      ...
      static void setmoveby(int pixels) { moveby = pixels; } 
      static void main();
};
