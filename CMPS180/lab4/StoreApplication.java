...
public class StoreApplication {
	...
	public List<String> getCustomerPhoneFromFirstLastName(Connection connection,
		...
		String query = "SELECT dv_address.phone FROM dv_customer Cust, dv_address Addr WHERE Cust.address_id = Addr.address_id AND ";
		query += "Cust.first_name = " + firstName + " AND Cust.last_name = " + lastName + ";";
